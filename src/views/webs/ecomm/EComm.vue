<template><div class="relative p-1">
	...
	<div class='absolute right-18 bottom-12 md:bottom-13 self-center w-44 md:w-64 bg-green-300 z-50'>
	...
	<div v-if='demo' class='p-16 text-xl md:text-2xl'>
		...
		<div class="text-base"> <a href="https://my-fake-json.herokuapp.com/" target="_blank" class='text-n8 border-b-2'>REST API</a></div>
	</div>	
...
<script setup>
	...
	import Cart from '/src/views/webs/ecomm/comps/Cart.vue'
	import Accessories from '/src/views/webs/ecomm/comps/Accessories.vue'
	import Laptops from '/src/views/webs/ecomm/comps/Laptops.vue'
	import Monitors from '/src/views/webs/ecomm/comps/Monitors.vue'
	import Storage from '/src/views/webs/ecomm/comps/Storage.vue'
